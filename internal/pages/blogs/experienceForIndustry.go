...
var ExperienceForIndustry = types.PageDetails{
	...
	Content: func(p types.PageDetails) *g.HTMLElement {
		...
		ue4Market := fnc.Add(a.ReferenceProps{
		...
		gameDevPD := fnc.Add(a.ReferenceProps{
		...
		gamingHowTo := fnc.Add(a.ReferenceProps{
		...
		deptJobs := fnc.Add(a.ReferenceProps{
			...
			Children: []*g.HTMLElement{
				...
				a.Row(g.CE{
					a.Col(g.CE{
						...
						a.P(g.EB{Text: "The games and software development industries seek out similar candidates but with select different skills." +
